...
- Docker: [chambul/medisimplifier:train-v14](https://hub.docker.com/r/chambul/medisimplifier)
...
nebius ai job create \
  ...
  --parent-id ${NEBIUS_PROJECT_ID} \
  --image chambul/medisimplifier:train-v14 \
...
> **Runtime setup:** Jobs use `chambul/medisimplifier:train-v14` (public Docker Hub),
...
| Parameter | Value |
|-----------|-------|
| Image | `chambul/medisimplifier:train-v14` (all deps pre-installed, public Docker Hub) |
| Platform | `gpu-h100-sxm` |
| Preset | `1gpu-16vcpu-200gb` |
| Disk | `250Gi` |
| Timeout | `5h` |
...
**Docker Hub (public — for judges):**
    ...
    docker pull chambul/medisimplifier:train-v14

**Nebius Container Registry (used in job configs):**

    cr.eu-north1.nebius.cloud/e00p4ryvm6npw9w9pz/medisimplifier:train-v14

Built from `docker/Dockerfile.train`. To rebuild:

    docker build -t chambul/medisimplifier:train-v14 -f docker/Dockerfile.train .
    docker push chambul/medisimplifier:train-v14
