...
> do not route real patient data through it. Reference simplifications in the training set were generated by Claude Opus 4.5
> (LLM teacher, not clinician-validated) — ROUGE-L measures similarity to these
> LLM-generated references, not to human-expert output quality.
